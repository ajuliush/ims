                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link  
                            {{ request()->is('add-product') ? 'collapsed' : '' }}
                            {{ request()->is('all-product') ? 'collapsed' : '' }}
                            {{ request()->is('available-products') ? 'collapsed' : '' }}
                                " href="#" data-toggle="collapse" data-target="#collapseProducts" aria-expanded="false" aria-controls="collapseProducts">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Products
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse 
                            {{ request()->is('add-product') ? 'show' : '' }}
                            {{ request()->is('all-product') ? 'show' : '' }}
                            {{ request()->is('available-products') ? 'show' : '' }}
                                " id="collapseProducts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                            ...
                            {{ request()->is('all-invoice') ? 'collapsed' : '' }}
                            " href="#" data-toggle="collapse" data-target="#collapseInvoice" aria-expanded="false" aria-controls="collapseInvoice">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Sales
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse
                            {{ request()->is('new-invoice') ? 'show' : '' }}
                            {{ request()->is('all-invoice') ? 'show' : '' }}
                            " id="collapseInvoice" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link
                            {{ request()->is('add-customer') ? 'collapsed' : '' }} 
                            {{ request()->is('all-customers') ? 'collapsed' : '' }} 
                            " href="#" data-toggle="collapse" data-target="#collapseAuthentication" aria-expanded="false" aria-controls="collapseAuthentication">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Customers
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse
                            {{ request()->is('add-customer') ? 'show' : '' }}
                            {{ request()->is('all-customers') ? 'show' : '' }}
                            " id="collapseInvoice" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
